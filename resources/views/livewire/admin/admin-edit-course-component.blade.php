<section id="home" class="home">
    <section class="gallery" style="margin-top: 6rem">
      <h1 class="heading" style="margin-top: -1.5rem" id="team"> Edit courses </h1>
      <!-- Inner -->
      <div class="">
        <!-- Single item -->
        <div class="mb-2">
                    ...
                    <div>
                        <div class="card">
                            <div class="card-body fs-3">
                                ...
                                @endif
                                <form class="" wire:submit.prevent="updatecourse">
                                    <div class="mb-5 mt-3">
                                    ...
                                    <div class="mb-5 mt-3">
                                        ...
                                        @else
                                            <img src="{{asset('assets/images/courses')}}/{{$image}}" width="120">
                                        @endif
                                        @error('image')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
